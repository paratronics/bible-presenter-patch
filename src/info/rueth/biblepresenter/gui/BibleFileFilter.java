 ...
 * $Id: BibleFileFilter.java,v 1.3 2004/04/28 09:53:58 Ulrich Rueth Exp $
 */
 ...
 * @author Jeff Dinkins
 */
public class BibleFileFilter extends FileFilter
{
	 ...
	 * @see #addExtension(String)
	 */
	public BibleFileFilter(String extension)
	{
		this(extension, null);
	}
	 ...
	 * @see #addExtension(String)
	 */
	public BibleFileFilter(String extension, String description)
	{
		this();
		if (extension != null)
	 ...
	 * @see #addExtension(String)
	 */
	public BibleFileFilter(String[] filters)
	{
		this(filters, null);
	}
	 ...
	 * @see #addExtension(String)
	 */
	public BibleFileFilter(String[] filters, String description)
	{
		this();
